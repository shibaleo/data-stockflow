...
app.use(headerChainRoute.getRoutingPath(), requireRole("platform", "tenant", "admin", "auditor"));
...
app.use(revisionChainRoute.getRoutingPath(), requireRole("platform", "tenant", "admin", "auditor"));
